...
\begin{enumerate}
    ...
    \item \textbf{Edge Hardware Deployment:} Porting the embedded Qdrant and transformer inference pipeline onto a Raspberry Pi 4B (8GB RAM, hardware procured; assembly and OS bring-up scheduled).
